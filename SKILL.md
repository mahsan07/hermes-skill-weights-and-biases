---
name: hermes-skill-weights-and-biases
description: Log ML experiments, run sweeps, manage a model registry, and build W&B dashboards. Use when the user explicitly requests this capability or a closely related task.
---
